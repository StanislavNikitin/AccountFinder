...
public class CookieParser {
    ...
    protected static final String[] DATE_PATTERNS = {"EEE, dd MMM yyyy HH:mm:ss 'GMT'"};
     ...
     */
    public CookieParser(String cookieStr){

        this.cookieStr = cookieStr;
        dateFormatter = new SimpleDateFormat(DATE_PATTERNS[0]);
